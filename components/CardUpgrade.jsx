  ...
  return(
    <>
      <main className={clsx("w-full h-full flex m-6 gap-6")}>
        ...
        <section className={clsx("flex w-[736px] h-[319px] rounded-xl border-[1px] lgbtiq-grad-bg-opacy justify-between items-center")}>
        ...
        <section className={clsx("w-[288px] h-[319px] rounded-xl border-[1px] bg-change-plan bg-cover p-6 flex justify-end flex-col")}>
