...
export default function TableEventsDos() {
  return(
    <>
      <table className="w-full text-center">
        <thead>
          <tr className="text-[13px] font-montserrat font-semibold text-blue-gray-800">
            <th className="border">Evento</th>
            <th className="border">Tematica</th>
            <th className="border">Fecha y hora</th>
            <th className="border">Costo</th>
            <th className="border">Aforo</th>
