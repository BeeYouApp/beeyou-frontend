...
// Adapt to CardEvents format - Component
...
//           <div
//             className={clsx(
//               "font-montserrat absolute bottom-0 left-0 right-0 px-4 py-2 text-montserrat text-[#FFFFFF]"
//             )}
//           >
//             <h5
//               className={clsx("text-[14px] font-bold leading-[15px] mt-[72px]")}
//             >
//               Cielito Querido
//             </h5>
