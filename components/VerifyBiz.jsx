...
//           />
//           <h1 className="pl-2">
//             Mi negocio participa activamente en eventos de la comunidad LGBTIQ+
//           </h1>
//         </label>
//         <label className="flex mb-4">
//           <input
...
//           />
//           <h1 className="pl-2">
//             Mi negocio está abierto a personas que forman parte de la comunidad
//             LGBTIQ+
//           </h1>
//         </label>
//         <label className="flex mb-4">
...
//             igualdad así como un mayor respeto por los derechos de las personas
//             LGBTIQ+ y sus identidades. Manifiesto de forma clara y contundente
//             mi oposición contra quienes abusan de las personas del colectivo así
//             como no permanecer impasible si sucede algún acontecimiento que
//             atente contra ellas en mi establecimiento. Es un compromiso ético y
//             personal con las personas LGBTIQ+ más allá del rédito económico que
//             pueda obtener por la prestación de servicios de bee you.
//           </h1>
//         </label>
//       </form>
