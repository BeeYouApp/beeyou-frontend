...
const schema = yup.object().shape({
  ...
  description: yup.string().trim().required("campo requerido").min(10, "requerido minimo 10 caracteres").max(300, "requerido maximo 300 caracteres"),
      ...
      <section onSubmit={handleSubmit(onSubmit)}>
        <article className="inline-block">
          <label className={clsx(
            ...
            'block ml-1 mt-1')}>NOMBRE DE TU EVENTO
          </label>
          <input
            id='username'
        ...
        <article className="inline-block m-4">
          <label className={clsx(
            'text-[10px] font-montserrat font-medium text-blue-gray-500',
            'block ml-1 mt-2')}>TIPO DE EVENTO / TEMÁTICA
          </label>
          <input
            id='username'
        ...
        <div className="inline-flex">
          <div >
            <article className="w-[300px] h-[100px]">
              <label className={clsx(
                'text-[10px] font-montserrat font-medium text-blue-gray-500',
                'block ml-1 mt-2')}>DESCRIPCIÓN DE TU EVENTO
              </label>
              <input
                id='username'
          ...
          <div className="ml-4">
            <label className={clsx(
              'text-[10px] font-montserrat font-medium text-blue-gray-500',
              'block ml-1 mt-2')}>IMAGEN del evento
            </label>
        ...
        <div className="inline-block"> 
          <article>
            <label className={clsx(
              'text-[10px] font-montserrat font-medium text-blue-gray-500',
              'block ml-1 mt-1')}>FECHA DE INICIO
            </label>
            <input
              htmlFor='timeStart' 
              id='username'
        ...
        <article className=" inline-block">
          <label className={clsx(
            'text-[10px] font-montserrat font-medium text-blue-gray-500',
            'block ml-1 mt-1')}>HORA DE INICIO
          </label>
          <input
            id='username'
