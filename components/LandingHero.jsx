  ...
  return (
    <main>
      <section className={clsx("flex flex-col lg:flex-row mx-4")}>
        <section
          className={clsx(
            "text-center md:text-start mt-10 md:mt-32 md:pl-8 lg:pl-14 lg:mt-[229px]"
          )}
        >
          <section className={clsx("md:flex")}>
            <article>
              ...
              <h1
                className={clsx(
                  "text-[32px] md:text-[56px] font-bold	font-montserrat text-blue-gray-900 mt-4 md:mt-0 leading-tight"
                )}
              >
                Únete a los
              </h1>
          ...
          <article
            className={clsx(
              "mt-5 font-montserrat text-blue-gray-700 md:max-w-lg lg:mt-8"
            )}
          >
            <p>
            ...
            <Button
              ...
              isSubmit
              style={clsx(
                "mt-8 lg:mb-16 lg:mt-[46px] lgbtiq-button-two lgbtiq-grad-bg"
              )}
            ></Button>
          </article>
        </section>
        <section
          className={clsx(
            "flex items-end p-8 md:w-6/6 md:mb-32 lg:w-3/6 lg:mt-[100px] lg:ml-32"
          )}
        >
