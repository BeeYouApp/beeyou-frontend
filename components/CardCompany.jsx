...
export default function CardCompany({
  ...
  return (
    <section className={clsx("w-[100%] m-1")}>
      <section
        className={clsx(
          "w-[100%] h-[400px] md:h-[259px] rounded-[16px] border-4",
          "border-blue-sky-50 shadow-xl flex flex-col md:flex-row"
        )}
      >
        <article
          className={clsx("w-[100%] md:w-[200px] h-full rounded-[16px]")}
        >
          <div className={clsx("flex justify-end")}>
            <button
              className={clsx(
                "w-[32px] h-[32px] bg-[#000000]/20 rounded-full absolute m-1"
              )}
            >
              <Image
        ...
        <section className={clsx("px-4 py-5 font-montserrat w-[100%]")}>
          <article className={clsx("flex")}>
            <h1
              className={clsx(
                "text-[18px] w-[65%] text-blue-gray-900 font-bold"
              )}
            >
              {title}
            </h1>
            <div className="w-[35%]">
              <h2
                className={clsx(
                  "text-[10px] text-blue-gray-500 mt-1.5 inline-block"
                )}
              >
                100% FIENDLY
              </h2>
          ...
          <article className={clsx("mt-1")}>{stars}</article>
          <article
            className={clsx("block mt-2 text-blue-gray-700 text-[14px]")}
          >
            {description}
          </article>
        ...
        <button
          className={clsx(
            "w-[100%] h-[26px] bg-blue-gray-900 text-[12px] text-[#FFFF] rounded-b-[10px] font-montserrat hover:font-bold md:hidden"
          )}
        >
          VER MÁS
        </button>
