			...
			<section className={clsx(
				...
				<article className="w-[200px] h-full rounded-[16px]">
					<div className="flex justify-end">
						<button className="w-[32px] h-[32px] bg-[#000000]/20 hover:bg-[#000000]/60 rounded-full m-1">
							<Image className={clsx("m-auto")} src={images.iconFavorite} alt="icon-favorite" />
						</button>
					</div>
					{image}
					<button className="w-[197px] h-[26px] bg-blue-gray-900 -mt-6 text-[12px] text-[#FFFF] rounded-b-[10px] font-montserrat hover:font-bold">VER MÁS</button>
				</article>
