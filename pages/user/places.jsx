      ...
      <div className="flex">
        ...
        <article className={clsx("px-4 md:px-8 mt-24 lg:mt-14 xl:mt-10")}>
          <div className="flex lg:mt-10 xl:mt-0">
            <h3
              className={clsx(
                "font-montserrat font-bold text-blue-gray-900 text-[24px] leading-[30px] mr-[79px]"
              )}
            >
              Tus espacios
            </h3>
            <div
              className={clsx(
                "hidden lg:flex justify-center items-center bg-blue-gray-50 rounded-full w-[129px]"
              )}
            >
              <h5
                className={clsx(
                  "font-montserrat font-medium text-blue-gray-800 text-[10px] leading-[12px] mr-1"
                )}
              >
                100% FRIENDLY
              </h5>
          ...
          <section className={clsx("md:flex md:justify-evenly")}>
            <div className={clsx("flex justify-center")}>
              <section
                className={clsx(
                  "hidden md:flex md:items-center md:mr-[85px] md:-ml-[40px] lg:ml-0 xl:mr-5 xl:-ml-[34px]"
                )}
              >
            ...
            <section
              className={clsx(
                "hidden md:flex md:items-center md:ml-[20px] md:-mr-[34px] lg:mr-0 xl:-ml-[25px] xl:-mr-[34px]"
              )}
            >
          ...
          <section
            className={clsx("lg:flex lg:items-center lg:justify-between")}
          >
            ...
            >
              ...
              <input
                ...
                className={clsx(
                  "font-montserrat form-input rounded-lg border border-gray-200 py-3 bg-white font-light placeholder-blue-gray-500 text-blue-gray-500 appearance-none w-full lg:w-[320px] block pl-16 focus:outline-none"
                )}
              />
            </label>
          </section>
